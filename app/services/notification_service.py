...
class NotificationService:
    ...
    async def dispute_resolved(
        ...
        The admin's notes are sent as-is — no auto-generated outcome lines.
        """
        text = (
            ...
            f"📝 <b>Admin's decision:</b>\n{notes}"
        )
        await self._send(buyer,  text, type="dispute_resolved", deal_id=deal.id)
        await self._send(seller, text, type="dispute_resolved", deal_id=deal.id)
